...
public class CustomerDemo {
	...
	public static void main(String[] args) {
				 	...
				 	int i;
					Customer1[] c= new RegularCustomer[5];
					Customer1[] p=new Privilegedcustomer[5];
					c[0]=new RegularCustomer(1, "aaa ", 9738340335l, 1000d);
					c[1]=new RegularCustomer(2, "sccc", 9738340336l, 2000d);
					c[2]=new RegularCustomer(3, "ddd ", 9738340337l, 4000d);
					c[3]=new RegularCustomer(4, " eee ", 9738340338l, 1900d);
					c[4]=new RegularCustomer(5, "eeert ", 973834033, 1800d);
